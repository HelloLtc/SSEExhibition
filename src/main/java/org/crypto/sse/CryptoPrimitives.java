...
public class CryptoPrimitives {
  ...
  //////////////////// and hash function SHA-256
  ///////////////////// (http://eprint.iacr.org/2007/197)/////////////////////////////
  /*我们开始研究在线密码。这些密码可以接受长度不等且变化的输入明文，并且仅处理了明文的前i个块后便会输出密文的第i个块。
   * 这样的密码仅通过数据一次就可以对数据流进行保留长度的加密。我们为此原语提供安全性定义，并研究其基本属性。
   * 然后，我们对某些可能的候选者提供攻击，包括具有固定IV的CBC。然后，基于给定的分组密码E和一系列计算AXU函数，我们提供了两种构造HCBC1和HCBC2。*/
  // ***********************************************************************************************//
  ...
  public static boolean[] StringToBoolean(String message) {
    if(message==null)
      return null;
